...
<article id="post-<?php the_ID(); ?>" <?php post_class('cell');?> role="article">
	<div class="inner">
		...
		<?php if( $article_link =  get_field('article_link') ):?>
			...
			<h3><a class="underlined" href="<?php echo $article_link;?>" target="_blank"><?php the_field('article_title');?></a></h3>
		
		<?php endif;?>
		
		<?php if( $article_pdf =  get_field('article_pdf') ):?>

			<h3><a class="underlined" href="<?php echo $article_pdf;?>" target="_blank"><?php the_field('article_title');?></a></h3>
